...
class Information(commands.Cog):
    ...
    async def robot_commands(self, ctx):
        ...
        image = "`l!cat`, `l!dog`, `l!fox`, `l!bird`, `l!duck`, `l!redpanda`, `l!tweet`," \
        ...
        memes = "`l!meme`, `l!linuxmeme`, `l!windowsmeme`, `l!wikihow`, `l!dankmeme`, `l!programmermeme`, " \
                "`l!edgymeme`, `l!darkmeme`, `l!discordmeme`, `l!applememe`, `l!minecraftmeme`"
    ...
    async def help(self, ctx):
        ...
        embed.set_footer(text=f"\n\nMade by TrackRunny#3281", icon_url=f"\n\nhttps://i.imgur.com/TiUqRH8.gif")
