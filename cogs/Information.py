...
class Information(commands.Cog):
    ...
    async def robot_commands(self, ctx):
        ...
        fun = "`l!coinflip`, `l!avatar`, `l!howgay`, `l!8ball`, `l!dice`, `l!dadjoke`, `l!geekjoke`, " \
              ...
              "`l!joke`, `l!chuck-norris`, `l!rps`, `l!advice`, `l!catfact`, `l!slot`, `l!question`"
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name=f"• LIBRARY Version:", inline=True, value=f":gear: — Discord.py version 1.3.2")
